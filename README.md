...
## Available methods 
Two main approaches are principally implemented:
- _Single Lagrange Multiplier_ (SLM), [Sanz García, JCTC, 2024] using Lagrang Multiplier and updating the BS numerically
